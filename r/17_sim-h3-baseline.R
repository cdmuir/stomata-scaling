# Recursion equations to determine stationary variance of V* under H3 baseline scenario
...
# First set of simulations start from a single common ancestor and simulate
# trait evolution on a star phylogeny with n_spp species.

dir1 = "sims/h3_baseline"
if (!dir.exists(dir1)) {
  dir.create(dir1)
}
